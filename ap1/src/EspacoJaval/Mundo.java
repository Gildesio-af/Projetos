...
public abstract class Mundo{
	private int vTranslacao, nBugs = 0, nDesenvolvedores = 0, tamOrbita = 0, contVoltas = 0;
    private float dias = 0f, anos = 0f, vRotacao;
    private double vMedia;
    private String resumo, nome, posicao;
    private boolean vivo, alinhado = false;
	...
	//testar
    public void rotacionar(int nInstantes){
        for (int i = 0; i < nInstantes; i++) {
            this.dias += this.vRotacao;
        }
        this.setDias(this.getDias());
    }
     //testado
	public  void transladar(int nInstantes){
